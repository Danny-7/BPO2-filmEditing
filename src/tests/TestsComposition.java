...
public class TestsComposition {
	...
	public void testCompositions() {
		...
		// on teste une � une les manipulations combin�es avec elles m�me
		...
		basicCheck(film, 2, 2, 6, "composition.txt");
		// la composition pr�c�dente est employ�e pour la manipulation suivante
		f = film;
	...
	public void testRéférencesPartagées() {
		...
		// un m�me film devrait pouvoir intervenir plusieurs fois dans un m�me collage 
		// (ce n'est pas le cas pour les incrustations (un film ne peut �tre
		// parcouru de 2 fois en parall�le sans surco�t r�dhibitoire)
