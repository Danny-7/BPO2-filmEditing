...
// L'interface Film permet la d�finition de film divers.
public class TestsExtra {	
	@Test
	public void testFilmAléatoire() {
		// Un film peut produire des images al�atoires.
		...
		assertTrue("les deux films doivent �tre distincts", diff);
	}

	@Test
	public void testFilmVariable() {
		// Un film peut produire des films d�terministes mais �tant diff�rents
		// d'un rembobinage � l'autre.
	...
	public void testFilmNeutre() {
		// Un film n'affecte pas n�cessairement tous les pixels de l'�cran.
		final int TAILLE = 2;
		...
		// les images (et le nombre d'images apr�s avoir rembobin� f)
		f.rembobiner();
		int n = 0;
